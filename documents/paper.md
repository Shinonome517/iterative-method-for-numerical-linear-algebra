...
$A \in \mathbb{C^{n \times n}}$が

$$
\forall i |a_{i, j}| \geq \sum_{j = 1, j \neq i}^n |a_{i, j}|
$$

を満たす時、$A$を**対角優位行列**といい、このような状態を**対角優位**であるという

---

## ヤコビ反復法

### ＜定理＞ ヤコビ反復法が収束するための十分条件

ヤコビ法で連立一次方程式$A\bf{x} = \bf{b}$を解く時、
ヤコビ法が収束するための十分条件は、$A$が**対角優位行列**であることである。
...
[ヤコビ法収束の十分条件](http://nkl.cc.u-tokyo.ac.jp/15n/SolverIterative-25-29.pdf)
